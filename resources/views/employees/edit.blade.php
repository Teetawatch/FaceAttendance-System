...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="section-title">แก้ไขข้อมูลพนักงาน</h2>
            <p class="section-subtitle">ปรับปรุงข้อมูลส่วนตัวหรือสถานะการทำงาน</p>
        </div>
            ...
            <div x-data="{ fileName: null, filePreview: null }">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="flex-shrink-0 text-center">
                        <p class="text-xs font-medium text-muted mb-2">รูปปัจจุบัน</p>
                        <div class="w-32 h-32 rounded-2xl overflow-hidden border-2 border-primary-100 mx-auto">
