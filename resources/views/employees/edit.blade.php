...
<div class="max-w-4xl mx-auto">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h2 class="text-2xl font-bold text-slate-800">แก้ไขข้อมูลพนักงาน</h2>
            <p class="text-slate-500 text-sm mt-1">ปรับปรุงข้อมูลส่วนตัวหรือสถานะการทำงาน</p>
        </div>
        ...
        <form action="{{ route('employees.update', $employee) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <!-- Status -->
                    <div>
                        <label class="block text-sm font-medium text-slate-700 mb-1.5">สถานะ</label>
                        <select name="is_active" class="w-full rounded-xl border-slate-200 focus:border-primary-500 focus:ring-primary-500 text-sm shadow-sm">
            ...
            <div x-data="{ fileName: null, filePreview: null }">
                ...
                <div class="flex flex-col md:flex-row gap-8">
                    ...
                    <div class="flex-shrink-0 text-center">
                        <p class="text-xs font-medium text-slate-500 mb-2">รูปปัจจุบัน</p>
                    ...
                    <div class="flex-1">
                        <label class="block text-sm font-medium text-slate-700 mb-1.5">อัปโหลดรูปใหม่ (ถ้าต้องการเปลี่ยน)</label>
