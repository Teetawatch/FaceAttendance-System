...
<div class="space-y-8">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
            ...
            <p class="text-indigo-600/70 mt-1">ยินดีต้อนรับกลับสู่ระบบจัดการเวลาเข้างาน</p>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div class="bg-card rounded-2xl p-6 border border-slate-200/60 shadow-[0_2px_10px_-3px_rgba(6,81,237,0.1)] hover:shadow-[0_8px_30px_-4px_rgba(6,81,237,0.1)] transition-all duration-300 group">
        ...
        <div class="bg-card rounded-2xl p-6 border border-slate-200/60 shadow-[0_2px_10px_-3px_rgba(16,185,129,0.1)] hover:shadow-[0_8px_30px_-4px_rgba(16,185,129,0.1)] transition-all duration-300 group">
            <div class="flex items-start justify-between">
                <div>
        ...
        <div class="bg-card rounded-2xl p-6 border border-slate-200/60 shadow-[0_2px_10px_-3px_rgba(245,158,11,0.1)] hover:shadow-[0_8px_30px_-4px_rgba(245,158,11,0.1)] transition-all duration-300 group">
            <div class="flex items-start justify-between">
                <div>
        ...
        <!-- Card 4: Devices -->
        <div class="bg-card rounded-2xl p-6 border border-slate-200/60 shadow-[0_2px_10px_-3px_rgba(139,92,246,0.1)] hover:shadow-[0_8px_30px_-4px_rgba(139,92,246,0.1)] transition-all duration-300 group">
            <div class="flex items-start justify-between">
                <div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 bg-card rounded-2xl border border-slate-200/60 shadow-sm overflow-hidden">
            <div class="px-6 py-5 border-b border-slate-50 flex items-center justify-between">
                <h3 class="font-bold text-text font-bold font-mono text-lg font-mono">การสแกนล่าสุด</h3>
                <a href="{{ route('attendance.index') }}" class="text-sm text-indigo-600 hover:text-primary-700 font-medium transition-colors">ดูทั้งหมด</a>
            </div>
            <div class="divide-y divide-slate-50">
                @forelse($recentScans as $scan)
                <div class="px-6 py-4 flex items-center justify-between hover:bg-slate-50/50 transition-colors group">
                    <div class="flex items-center gap-4">
                        <div class="w-12 h-12 rounded-full bg-slate-50 flex items-center justify-center overflow-hidden border-2 border-white shadow-sm group-hover:border-slate-200 transition-colors">
                        ...
                        <div>
                            <p class="font-bold text-text group-hover:text-indigo-600 transition-colors">
                                {{ $scan->employee ? $scan->employee->first_name . ' ' . $scan->employee->last_name : 'Unknown' }}
                            </p>
                            <div class="flex items-center gap-2 mt-0.5">
                                <span class="text-xs text-primary-400 bg-slate-50 px-2 py-0.5 rounded border border-slate-200/60">
                    ...
                    <div class="text-right">
                        ...
                        <p class="text-sm font-medium text-indigo-600/70 mt-1 font-mono">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-card rounded-2xl border border-slate-200/60 shadow-sm p-6">
