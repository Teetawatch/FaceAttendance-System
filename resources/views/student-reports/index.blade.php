...
<div class="space-y-6" x-data="{ showEmailModal: false }">
    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div class="flex items-center gap-2">
            ...
            <button @click="showEmailModal = true" class="inline-flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-xl transition-all shadow-sm hover:shadow-md text-sm font-medium">
    ...
    <div x-show="showEmailModal" 
        ...
        <div x-show="showEmailModal"
            ...
            <form action="{{ route('student-reports.send-email') }}" method="POST" class="p-6 space-y-5">
                ...
                <!-- Email Input -->
                <div>
                    <label class="block text-sm font-medium text-slate-700 mb-2">อีเมลปลายทาง <span class="text-rose-500">*</span></label>
