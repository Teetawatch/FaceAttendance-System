    ...
    <div class="mb-8">
        <div class="flex items-center gap-4">
            <div class="w-14 h-14 bg-gradient-to-br from-violet-500 to-purple-600 rounded-2xl flex items-center justify-center shadow-lg shadow-violet-500/25">
                <x-heroicon-o-user-plus class="text-white text-xl w-5"/>
            </div>
            <div>
        ...
        <div class="bg-card rounded-3xl shadow-lg border border-slate-200/60 overflow-hidden">
            ...
            <div class="relative aspect-[4/3] bg-slate-900">
                ...
                <div x-show="!isCameraReady" class="absolute inset-0 bg-slate-900 flex flex-col items-center justify-center text-white">
                    <x-heroicon-o-arrow-path class="text-4xl mb-4 text-violet-400 w-5"/>
            ...
            <div class="bg-card rounded-3xl shadow-lg border border-slate-200/60 overflow-hidden">
                <div class="px-6 py-4 border-b border-slate-200/60 bg-gradient-to-r from-slate-50 to-white">
                    <h2 class="font-bold text-text font-bold font-mono flex items-center gap-2 font-mono">
                        <x-heroicon-o-user-circle class="text-violet-500 w-5"/>
                        เลือกพนักงาน
                    </h2>
                </div>
                <div class="p-6">
                                ...
                                <div class="w-14 h-14 rounded-xl overflow-hidden flex-shrink-0 border-2 border-white shadow-sm"
                                    ...
                                    <template x-if="!emp.has_photo">
                                        <div class="w-full h-full flex items-center justify-center text-primary-400">
                                            <x-heroicon-o-user class="text-xl w-5"/>
                                        </div>
                                    </template>
                                </div>
            ...
            <div x-show="selectedEmployee" x-transition class="bg-slate-900 rounded-3xl shadow-2xl p-6 text-white border border-slate-700">
                <div class="flex items-center gap-4 mb-4">
                    <div class="w-16 h-16 rounded-2xl overflow-hidden bg-slate-800 border-2 border-slate-600 shadow-lg">
                        ...
                        <template x-if="!selectedEmployee?.has_photo">
                            <div class="w-full h-full flex items-center justify-center text-primary-400">
                                <x-heroicon-o-user class="text-2xl w-5"/>
                            </div>
                        </template>
                    </div>
                    <div>
                ...
                <div class="bg-slate-800 rounded-xl p-4 border border-slate-700">
                    <p class="text-white text-sm font-medium">
                        <x-heroicon-o-information-circle class="mr-2 text-violet-400 w-5"/>
