                    ...
                    <tr class="hover:bg-slate-50 transition-colors">
                        ...
                        <td class="px-6 py-4">
                            @if($user->signature_path)
                                <span class="text-green-600 text-sm flex items-center gap-1"><x-heroicon-o-check class="w-5"/> มีแล้ว</span>
                            @else
