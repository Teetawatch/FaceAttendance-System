...
<div x-data="studentFaceRegisterApp()" x-init="init()" class="max-w-6xl mx-auto">
    ...
    <div class="mb-8">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h1 class="section-title">ลงทะเบียนใบหน้านักเรียน</h1>
                <p class="section-subtitle">ถ่ายรูปใบหน้านักเรียนจากกล้องโดยตรง เพื่อใช้ในการสแกนลงเวลา</p>
            </div>
        </div>
    </div>
                        ...
                        <div class="flex-1 flex gap-3">
                            ...
                            <button @click="savePhoto()" 
                                ...
                                <template x-if="!isLoading">
                                    <span class="flex items-center gap-2"> บันทึก</span>
                                </template>
                                <template x-if="isLoading">
            ...
            <div class="card overflow-hidden">
                <div class="px-5 py-4 border-b border-primary-100/60 bg-surface-50/40">
                    <h2 class="text-sm font-semibold text-text flex items-center gap-2">
                        <i data-lucide="filter" class="w-4 h-4 text-muted"></i>
                        กรองตามหลักสูตร
                    </h2>
                </div>
                <div class="p-6">
            ...
            <div class="card overflow-hidden">
                <div class="px-5 py-4 border-b border-primary-100/60 bg-surface-50/40">
                    <h2 class="text-sm font-semibold text-text flex items-center gap-2">
                        ...
                        เลือกนักเรียน
                        <span class="ml-auto text-xs font-normal text-muted" x-text="'(' + filteredStudents.length + ' คน)'"></span>
                    </h2>
                </div>
                <div class="p-6">
                    <!-- Search Input -->
