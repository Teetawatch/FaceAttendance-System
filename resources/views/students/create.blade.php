...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <div class="flex items-center gap-4">
        ...
        <div>
            <h2 class="text-2xl font-bold text-slate-800">👨‍🎓 เพิ่มนักเรียนใหม่</h2>
            <p class="text-slate-500 text-sm">กรอกข้อมูลนักเรียน</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-slate-100 p-6">
        <form action="{{ route('students.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <!-- Photo -->
            <div>
                <label class="block text-sm font-medium text-slate-700 mb-2">รูปถ่าย (สำหรับสแกนใบหน้า)</label>
